...
class Quad3D():
    ...
    def __init__(self, env:BaseAviary):
        ...
        self.p_coeff_position["x"] = 0.7 * 0.9
        self.d_coeff_position["x"] = 2 * 0.5 

        self.p_coeff_position["z"] = 0.7 * 0.9
        self.d_coeff_position["z"] = 2 * 0.5 
    
        self.p_coeff_position["y"] = 0.7 * 0.9
        self.d_coeff_position["y"] = 2 * 0.5 
